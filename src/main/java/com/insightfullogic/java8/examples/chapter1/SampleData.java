...
public class SampleData {
    ...
    public static Stream<Album> getStreamAlbums() {
        return Stream.of(aLoveSupreme, manyTrackAlbum);
    }
    
    public static List<Album> twoAlbums = List.of(aLoveSupreme, manyTrackAlbum);
